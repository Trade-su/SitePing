var R,xe,Ue;function Xe(s,e){if(Ue=new Date,s.nodeType!==Node.ELEMENT_NODE)throw new Error("Can't generate CSS selector for non-element node type.");if(s.tagName.toLowerCase()==="html")return"html";let t={root:document.body,idName:i=>!0,className:i=>!0,tagName:i=>!0,attr:(i,o)=>!1,seedMinLength:1,optimizedMinLength:2,threshold:1e3,maxNumberOfTries:1e4,timeoutMs:void 0};R={...t,...e},xe=Jt(R.root,t);let n=U(s,"all",()=>U(s,"two",()=>U(s,"one",()=>U(s,"none"))));if(n){let i=Ge(Qe(n,s));return i.length>0&&(n=i[0]),V(n)}else throw new Error("Selector was not found.")}function Jt(s,e){return s.nodeType===Node.DOCUMENT_NODE?s:s===e.root?s.ownerDocument:s}function U(s,e,t){let n=null,i=[],o=s,r=0;for(;o;){let a=new Date().getTime()-Ue.getTime();if(R.timeoutMs!==void 0&&a>R.timeoutMs)throw new Error(`Timeout: Can't find a unique selector after ${a}ms`);let p=W(Zt(o))||W(...es(o))||W(...ts(o))||W(ss(o))||[qe()],d=ns(o);if(e=="all")d&&(p=p.concat(p.filter(ve).map(c=>X(c,d))));else if(e=="two")p=p.slice(0,1),d&&(p=p.concat(p.filter(ve).map(c=>X(c,d))));else if(e=="one"){let[c]=p=p.slice(0,1);d&&ve(c)&&(p=[X(c,d)])}else e=="none"&&(p=[qe()],d&&(p=[X(p[0],d)]));for(let c of p)c.level=r;if(i.push(p),i.length>=R.seedMinLength&&(n=Ke(i,t),n))break;o=o.parentElement,r++}return n||(n=Ke(i,t)),!n&&t?t():n}function Ke(s,e){let t=Ge(Ve(s));if(t.length>R.threshold)return e?e():null;for(let n of t)if(We(n))return n;return null}function V(s){let e=s[0],t=e.name;for(let n=1;n<s.length;n++){let i=s[n].level||0;e.level===i-1?t=`${s[n].name} > ${t}`:t=`${s[n].name} ${t}`,e=s[n]}return t}function Ye(s){return s.map(e=>e.penalty).reduce((e,t)=>e+t,0)}function We(s){let e=V(s);switch(xe.querySelectorAll(e).length){case 0:throw new Error(`Can't select any node with this selector: ${e}`);case 1:return!0;default:return!1}}function Zt(s){let e=s.getAttribute("id");return e&&R.idName(e)?{name:"#"+CSS.escape(e),penalty:0}:null}function es(s){return Array.from(s.attributes).filter(t=>R.attr(t.name,t.value)).map(t=>({name:`[${CSS.escape(t.name)}="${CSS.escape(t.value)}"]`,penalty:.5}))}function ts(s){return Array.from(s.classList).filter(R.className).map(t=>({name:"."+CSS.escape(t),penalty:1}))}function ss(s){let e=s.tagName.toLowerCase();return R.tagName(e)?{name:e,penalty:2}:null}function qe(){return{name:"*",penalty:3}}function ns(s){let e=s.parentNode;if(!e)return null;let t=e.firstChild;if(!t)return null;let n=0;for(;t&&(t.nodeType===Node.ELEMENT_NODE&&n++,t!==s);)t=t.nextSibling;return n}function X(s,e){return{name:s.name+`:nth-child(${e})`,penalty:s.penalty+1}}function ve(s){return s.name!=="html"&&!s.name.startsWith("#")}function W(...s){let e=s.filter(is);return e.length>0?e:null}function is(s){return s!=null}function*Ve(s,e=[]){if(s.length>0)for(let t of s[0])yield*Ve(s.slice(1,s.length),e.concat(t));else yield e}function Ge(s){return[...s].sort((e,t)=>Ye(e)-Ye(t))}function*Qe(s,e,t={counter:0,visited:new Map}){if(s.length>2&&s.length>R.optimizedMinLength)for(let n=1;n<s.length-1;n++){if(t.counter>R.maxNumberOfTries)return;t.counter+=1;let i=[...s];i.splice(n,1);let o=V(i);if(t.visited.has(o))return;We(i)&&os(i,e)&&(yield i,t.visited.set(o,!0),yield*Qe(i,e,t))}}function os(s,e){return xe.querySelector(V(s))===e}var rs=["role","aria-label","type","name","href","src","data-testid","data-id"];function as(s){let e=5381;for(let t=0;t<s.length;t++)e=(e<<5)+e+s.charCodeAt(t)|0;return(e>>>0).toString(36)}function ye(s){let e=s.children.length,t=0,n=s.parentElement;if(n)for(let r of n.children){if(r===s)break;r.tagName===s.tagName&&t++}let i=[];for(let r of rs){let a=s.getAttribute(r);a&&i.push(`${r}=${a}`)}let o=i.length>0?as(i.join(",")):"0";return`${e}:${t}:${o}`}function Je(s,e){let t=e.split(":");if(t.length!==3)return 0;let[n,i,o]=t,r=Number(n),a=Number(i);if(Number.isNaN(r)||Number.isNaN(a))return 0;let p=ye(s),[d,c,b]=p.split(":"),g=0,f=Math.abs(Number(d)-r);f===0?g+=.2:f<=2?g+=.1:f<=5&&(g+=.03);let x=Math.abs(Number(c)-a);return x===0?g+=.4:x===1?g+=.2:x<=3&&(g+=.08),b===o&&(g+=.4),g}function D(s,e){let t=e==="before"?"previousElementSibling":"nextElementSibling",n=s[t],i=3;for(;n&&i>0;){let o=n.textContent?.trim();if(o)return e==="before"?o.slice(-32):o.slice(0,32);n=n[t],i--}return""}function G(s){let e=s.previousElementSibling?.textContent?.trim().slice(0,40)??"",t=s.nextElementSibling?.textContent?.trim().slice(0,40)??"";return[e,t].filter(Boolean).join(" | ")}function Ze(s){if(s.id){let n=s.id.includes("'")?`concat('${s.id.replace(/'/g,`',"'",'`)}')`:`'${s.id}'`;return`//${s.localName}[@id=${n}]`}let e=[],t=s;for(;t&&t!==document.body&&e.length<6;){let n=t.localName,i=t.parentElement;if(t.id){let r=t.id.includes("'")?`concat('${t.id.replace(/'/g,`',"'",'`)}')`:`'${t.id}'`;return e.unshift(`/${n}[@id=${r}]`),"/"+e.join("")}let o=1;if(i)for(let r of i.children){if(r===t)break;r.localName===n&&o++}e.unshift(`/${n}[${o}]`),t=i}return"/html/body"+e.join("")}function ke(s){let e=Xe(s,{className:d=>!/^(css|sc|emotion|styled)-/.test(d)&&!/^[a-z]{1,3}[A-Za-z0-9]{4,8}$/.test(d),attr:d=>["data-testid","data-id","role","aria-label"].includes(d),idName:d=>!d.startsWith("radix-")&&!/^:r[0-9]+:$/.test(d),seedMinLength:3,optimizedMinLength:2}),t=Ze(s),i=(s.textContent?.trim()??"").slice(0,120),o=D(s,"before"),r=D(s,"after"),a=ye(s),p=G(s);return{cssSelector:e,xpath:t,textSnippet:i,textPrefix:o,textSuffix:r,fingerprint:a,neighborText:p,elementTag:s.tagName,elementId:s.id||void 0}}function et(s,e=document.documentElement){let t=s.x+s.width/2,n=s.y+s.height/2,i=document.elementFromPoint(t,n);if(!i||i===e)return document.body;let o=i,r=i;for(;r&&r!==document.body;){let a=r.getBoundingClientRect();if(a.left<=s.x&&a.top<=s.y&&a.right>=s.x+s.width&&a.bottom>=s.y+s.height){o=r;break}r=r.parentElement}return o}function tt(s,e){return e.width<=0||e.height<=0?{xPct:0,yPct:0,wPct:1,hPct:1}:{xPct:(s.x-e.x)/e.width,yPct:(s.y-e.y)/e.height,wPct:s.width/e.width,hPct:s.height/e.height}}function v(s){let n=document.createRange().createContextualFragment(s).firstElementChild;if(!n||n.nodeName.toLowerCase()!=="svg")throw new Error("[siteping] Invalid SVG string");for(let i of[...n.attributes])i.name.startsWith("on")&&n.removeAttribute(i.name);for(let i of n.querySelectorAll("*"))for(let o of[...i.attributes])o.name.startsWith("on")&&i.removeAttribute(o.name);return n}function l(s,e){let t=document.createElement(s);if(e)for(let[n,i]of Object.entries(e))n==="class"?t.className=i:n==="style"?t.style.cssText=i:t.setAttribute(n,i);return t}function h(s,e){s.textContent=e}function Q(s,e="en"){let t=Date.now()-new Date(s).getTime(),n=Math.floor(t/1e3);if(n<60)return new Intl.RelativeTimeFormat(e,{numeric:"auto"}).format(0,"second");let i=new Intl.RelativeTimeFormat(e,{numeric:"always",style:"narrow"}),o=Math.floor(n/60);if(o<60)return i.format(-o,"minute");let r=Math.floor(o/60);if(r<24)return i.format(-r,"hour");let a=Math.floor(r/24);return a<7?i.format(-a,"day"):new Date(s).toLocaleDateString(e)}var we='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><circle cx="12" cy="10" r="1" fill="currentColor" stroke="none"/><circle cx="8" cy="10" r="1" fill="currentColor" stroke="none"/><circle cx="16" cy="10" r="1" fill="currentColor" stroke="none"/></svg>',st='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',nt='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18"/><path d="M9 3v18"/></svg>',Ce='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>',Ee='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/><line x1="1" y1="1" x2="23" y2="23"/></svg>',J='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>',it='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>',ot='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>',rt='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>',at='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>',lt='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="8" y="6" width="8" height="14" rx="4"/><path d="M19 9h2"/><path d="M3 9h2"/><path d="M19 13h2"/><path d="M3 13h2"/><path d="M19 17h2"/><path d="M3 17h2"/><path d="M10 2h4"/></svg>',pt='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg>',dt='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/></svg>',Te='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>';var ht="#0066ff",ls=/^#[0-9a-fA-F]{6}$/,ct=/^#([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])$/,ps=/^#[0-9a-fA-F]{8}$/;function ds(s){if(ls.test(s))return s;let e=ct.test(s)?s.match(ct):null;return e?`#${e[1]}${e[1]}${e[2]}${e[2]}${e[3]}${e[3]}`:ps.test(s)?s.slice(0,7):(console.warn(`[siteping] Invalid accentColor "${s}" \u2014 only hex colors (#RGB, #RRGGBB, #RRGGBBAA) are supported. Using default.`),ht)}function cs(s,e){let t=Math.max(0,Math.round(parseInt(s.slice(1,3),16)*(1-e))),n=Math.max(0,Math.round(parseInt(s.slice(3,5),16)*(1-e))),i=Math.max(0,Math.round(parseInt(s.slice(5,7),16)*(1-e)));return`#${t.toString(16).padStart(2,"0")}${n.toString(16).padStart(2,"0")}${i.toString(16).padStart(2,"0")}`}function hs(){return typeof window>"u"?!1:window.matchMedia("(prefers-color-scheme: dark)").matches}function us(s){return s==="dark"||s==="auto"&&hs()?"dark":"light"}function ut(s=ht,e){let t=ds(s),n=cs(t,.15);return us(e)==="dark"?{accent:t,accentLight:t+"22",accentDark:n,accentGlow:t+"44",accentGradient:`linear-gradient(135deg, ${t}, ${n})`,bg:"#0f172a",bgHover:"#1e293b",text:"#f1f5f9",textSecondary:"#94a3b8",textTertiary:"#64748b",border:"#334155",shadow:"rgba(0, 0, 0, 0.3)",glassBg:"rgba(15, 23, 42, 0.78)",glassBgHeavy:"rgba(15, 23, 42, 0.88)",glassBorder:"rgba(51, 65, 85, 0.5)",glassBorderSubtle:"rgba(51, 65, 85, 0.3)",typeQuestion:"#60a5fa",typeChange:"#fbbf24",typeBug:"#f87171",typeOther:"#94a3b8",typeQuestionBg:"rgba(59, 130, 246, 0.15)",typeChangeBg:"rgba(245, 158, 11, 0.15)",typeBugBg:"rgba(239, 68, 68, 0.15)",typeOtherBg:"rgba(100, 116, 139, 0.15)"}:{accent:t,accentLight:t+"14",accentDark:n,accentGlow:t+"33",accentGradient:`linear-gradient(135deg, ${t}, ${n})`,bg:"#ffffff",bgHover:"#f8f9fb",text:"#0f172a",textSecondary:"#475569",textTertiary:"#64748b",border:"#e2e8f0",shadow:"rgba(0, 0, 0, 0.06)",glassBg:"rgba(255, 255, 255, 0.72)",glassBgHeavy:"rgba(255, 255, 255, 0.85)",glassBorder:"rgba(255, 255, 255, 0.35)",glassBorderSubtle:"rgba(255, 255, 255, 0.18)",typeQuestion:"#3b82f6",typeChange:"#b45309",typeBug:"#ef4444",typeOther:"#64748b",typeQuestionBg:"#eff6ff",typeChangeBg:"#fffbeb",typeBugBg:"#fef2f2",typeOtherBg:"#f8fafc"}}function B(s,e){switch(s){case"question":return e.typeQuestion;case"change":return e.typeChange;case"bug":return e.typeBug;default:return e.typeOther}}function N(s,e){switch(s){case"question":return e.typeQuestionBg;case"change":return e.typeChangeBg;case"bug":return e.typeBugBg;default:return e.typeOtherBg}}function bt(s){return`
    --sp-accent: ${s.accent};
...
`;function $s(s){if(/Edg\//i.test(s)){let e=s.match(/Edg\/([\d.]+)/);return e?`Edge ${e[1]}`:"Edge"}if(/OPR\//i.test(s)||/Opera/i.test(s)){let e=s.match(/OPR\/([\d.]+)/);return e?`Opera ${e[1]}`:"Opera"}if(/Firefox\//i.test(s)){let e=s.match(/Firefox\/([\d.]+)/);return e?`Firefox ${e[1]}`:"Firefox"}if(/Chrome\//i.test(s)&&!/Chromium/i.test(s)){let e=s.match(/Chrome\/([\d.]+)/);return e?`Chrome ${e[1]}`:"Chrome"}if(/Safari\//i.test(s)&&!/Chrome/i.test(s)){let e=s.match(/Version\/([\d.]+)/);return e?`Safari ${e[1]}`:"Safari"}return"Unknown"}function Ht(s,e){try{return new Date(s).toLocaleString(e,{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return s}}function _s(s){try{return new URL(s).pathname}catch{return s}}function Ot(s,e){return s.length<=e?s:s.slice(0,e-1)+"\u2026"}var de=class{constructor(e,t,n){this.colors=e;this.callbacks=t;this.i18n=n.startsWith("fr")?Ne:Ds,this.element=l("div",{class:"sp-detail"}),this.element.setAttribute("role","dialog"),this.element.setAttribute("aria-label","Feedback detail"),this.element.setAttribute("aria-hidden","true");let i=l("div",{class:"sp-detail-header"}),o=document.createElement("button");o.type="button",o.className="sp-detail-back",o.setAttribute("aria-label",this.i18n["detail.back"]),o.appendChild(v(Fs)),o.addEventListener("click",()=>{this.hide(),this.callbacks.onBack()}),this.element.appendChild(i),i.appendChild(o),this.content=l("div",{class:"sp-detail-content"}),this.element.appendChild(this.content)}colors;callbacks;element;_isVisible=!1;currentFeedback=null;content;i18n;resolveBtn=null;deleteBtn=null;isProcessing=!1;show(e,t){this.currentFeedback=e,this.isProcessing=!1;let n=this.element.querySelector(".sp-detail-header");if(!n)return;let i=n.querySelector(".sp-detail-back");if(!i)return;n.replaceChildren(i);let o=l("span",{class:"sp-detail-title"});h(o,this.i18n["detail.title"].replace("{number}",String(t))),n.appendChild(o);let r=l("span",{class:"sp-badge"});r.style.background=N(e.type,this.colors),r.style.color=B(e.type,this.colors),h(r,e.type),n.appendChild(r),this.content.replaceChildren();let a=0,p=this.buildSection(a++);this.buildStatusActions(p,e),this.content.appendChild(p);let d=this.buildSection(a++),c=l("div",{class:"sp-detail-section-title"});h(c,this.i18n["detail.message"]),d.appendChild(c);let b=l("div",{class:"sp-detail-message"});b.style.borderLeftColor=B(e.type,this.colors),h(b,e.message),d.appendChild(b),this.content.appendChild(d);let g=this.buildSection(a++),f=l("div",{class:"sp-detail-section-title"});if(h(f,this.i18n["detail.metadata"]),g.appendChild(f),this.buildMetadata(g,e),this.content.appendChild(g),e.annotations.length>0){let x=this.buildSection(a++),k=l("div",{class:"sp-detail-section-title"});k.appendChild(v(Ie));let C=l("span");h(C,this.i18n["detail.annotation"]),k.appendChild(C),x.appendChild(k),this.buildAnnotation(x,e),this.content.appendChild(x)}this._isVisible=!0,this.element.setAttribute("aria-hidden","false"),this.element.offsetHeight,this.element.classList.add("sp-detail--visible"),requestAnimationFrame(()=>{i.focus()})}hide(){this._isVisible&&(this._isVisible=!1,this.element.classList.remove("sp-detail--visible"),this.element.setAttribute("aria-hidden","true"),this.currentFeedback=null,this.resolveBtn=null,this.deleteBtn=null)}get isVisible(){return this._isVisible}destroy(){this.hide(),this.element.remove()}buildSection(e){let t=l("div",{class:"sp-detail-section"});return t.style.animationDelay=`${e*40}ms`,t}buildStatusActions(e,t){let n=t.status==="resolved",i=l("div",{class:"sp-detail-section-title"});h(i,this.i18n["detail.status"]),e.appendChild(i);let o=l("div",{class:"sp-detail-status"}),r=l("span",{class:`sp-detail-status-pill ${n?"sp-detail-status-pill--resolved":"sp-detail-status-pill--open"}`}),a=l("span",{class:"sp-detail-status-dot"});a.style.background=n?"#9ca3af":"#22c55e",r.appendChild(a);let p=l("span");h(p,n?this.i18n["detail.reopen"]:this.i18n["detail.resolve"]),h(p,n?"Resolved":"Open"),r.appendChild(p),o.appendChild(r),e.appendChild(o);let d=l("div",{class:"sp-detail-actions"});if(this.resolveBtn=document.createElement("button"),this.resolveBtn.type="button",n){this.resolveBtn.className="sp-detail-btn-reopen",this.resolveBtn.appendChild(v(Pt));let b=document.createElement("span");h(b,this.i18n["detail.reopen"]),this.resolveBtn.appendChild(b)}else{this.resolveBtn.className="sp-detail-btn-resolve",this.resolveBtn.appendChild(v(Pe));let b=document.createElement("span");h(b,this.i18n["detail.resolve"]),this.resolveBtn.appendChild(b)}this.resolveBtn.addEventListener("click",()=>this.handleResolve()),this.deleteBtn=document.createElement("button"),this.deleteBtn.type="button",this.deleteBtn.className="sp-detail-btn-delete",this.deleteBtn.appendChild(v(Nt));let c=document.createElement("span");h(c,this.i18n["detail.delete"]),this.deleteBtn.appendChild(c),this.deleteBtn.addEventListener("click",()=>this.handleDelete()),d.appendChild(this.resolveBtn),d.appendChild(this.deleteBtn),e.appendChild(d)}buildMetadata(e,t){let n=l("div",{class:"sp-detail-meta"});if(this.addMetaRow(n,Rs,this.i18n["detail.page"],()=>{let i=l("div",{class:"sp-detail-meta-value"}),o=_s(t.url);return h(i,Ot(o,60)),i.title=t.url,i}),this.addMetaRow(n,Is,this.i18n["detail.author"],()=>{let i=l("div",{class:"sp-detail-meta-value"}),o=t.authorName||"Anonymous",r=t.authorEmail;return h(i,r?`${o} (${r})`:o),i}),this.addMetaRow(n,Ps,this.i18n["detail.date"],()=>{let i=l("div",{class:"sp-detail-meta-value"});return h(i,Ht(t.createdAt,this.i18n===Ne?"fr":"en")),i}),this.addMetaRow(n,Ns,this.i18n["detail.viewport"],()=>{let i=l("div",{class:"sp-detail-meta-value sp-detail-meta-value--mono"});return h(i,t.viewport||"Unknown"),i}),this.addMetaRow(n,'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',this.i18n["detail.browser"],()=>{let i=l("div",{class:"sp-detail-meta-value"});return h(i,$s(t.userAgent)),i}),t.resolvedAt){let i=t.resolvedAt;this.addMetaRow(n,Pe,this.i18n["detail.resolvedAt"],()=>{let o=l("div",{class:"sp-detail-meta-value sp-detail-meta-value--secondary"});return h(o,Ht(i,this.i18n===Ne?"fr":"en")),o})}e.appendChild(n)}addMetaRow(e,t,n,i){let o=l("div",{class:"sp-detail-meta-row"});o.appendChild(v(t));let r=l("div",{class:"sp-detail-meta-content"}),a=l("div",{class:"sp-detail-meta-label"});h(a,n),r.appendChild(a),r.appendChild(i()),o.appendChild(r),e.appendChild(o)}buildAnnotation(e,t){let n=t.annotations[0];if(!n)return;let i=l("div",{class:"sp-detail-annotation"}),o=l("div",{class:"sp-detail-annotation-info"});this.addAnnotationRow(o,Hs,this.i18n["detail.element"],()=>{let p=l("span",{class:"sp-detail-annotation-value sp-detail-annotation-value--mono"}),d=n.elementId?`<${n.elementTag}#${n.elementId}>`:`<${n.elementTag}>`;return h(p,d),p}),this.addAnnotationRow(o,Os,this.i18n["detail.selector"],()=>{let p=l("span",{class:"sp-detail-annotation-value sp-detail-annotation-value--mono"});return h(p,Ot(n.cssSelector,60)),p.title=n.cssSelector,p}),this.addAnnotationRow(o,Ie,this.i18n["detail.position"],()=>{let p=l("span",{class:"sp-detail-annotation-value"});return h(p,`${n.xPct.toFixed(1)}%, ${n.yPct.toFixed(1)}%`+(n.wPct>0||n.hPct>0?` (${n.wPct.toFixed(1)}% \xD7 ${n.hPct.toFixed(1)}%)`:"")),p}),i.appendChild(o);let r=document.createElement("button");r.type="button",r.className="sp-detail-btn-goto",r.appendChild(v(Ie));let a=document.createElement("span");h(a,this.i18n["detail.goToAnnotation"]),r.appendChild(a),r.addEventListener("click",()=>{this.currentFeedback&&this.callbacks.onGoToAnnotation(this.currentFeedback)}),i.appendChild(r),e.appendChild(i)}addAnnotationRow(e,t,n,i){let o=l("div",{class:"sp-detail-annotation-row"});o.appendChild(v(t));let r=l("div",{class:"sp-detail-meta-content"}),a=l("div",{class:"sp-detail-annotation-label"});h(a,n),r.appendChild(a),r.appendChild(i()),o.appendChild(r),e.appendChild(o)}async handleResolve(){if(!(this.isProcessing||!this.currentFeedback)){this.isProcessing=!0,this.resolveBtn&&this.setButtonLoading(this.resolveBtn),this.deleteBtn&&(this.deleteBtn.disabled=!0);try{await this.callbacks.onResolve(this.currentFeedback)}catch{this.isProcessing=!1,this.resolveBtn&&this.restoreResolveBtn(this.currentFeedback),this.deleteBtn&&(this.deleteBtn.disabled=!1)}}}async handleDelete(){if(!(this.isProcessing||!this.currentFeedback)){this.isProcessing=!0,this.deleteBtn&&this.setButtonLoading(this.deleteBtn),this.resolveBtn&&(this.resolveBtn.disabled=!0);try{await this.callbacks.onDelete(this.currentFeedback)}catch{this.isProcessing=!1,this.deleteBtn&&this.restoreDeleteBtn(),this.resolveBtn&&(this.resolveBtn.disabled=!1)}}}setButtonLoading(e){e.disabled=!0,e.replaceChildren(l("div",{class:"sp-spinner sp-spinner--sm"}))}restoreResolveBtn(e){if(!this.resolveBtn)return;this.resolveBtn.disabled=!1,this.resolveBtn.replaceChildren();let t=e.status==="resolved";this.resolveBtn.appendChild(v(t?Pt:Pe));let n=document.createElement("span");h(n,t?this.i18n["detail.reopen"]:this.i18n["detail.resolve"]),this.resolveBtn.appendChild(n)}restoreDeleteBtn(){if(!this.deleteBtn)return;this.deleteBtn.disabled=!1,this.deleteBtn.replaceChildren(),this.deleteBtn.appendChild(v(Nt));let e=document.createElement("span");h(e,this.i18n["detail.delete"]),this.deleteBtn.appendChild(e)}};var js='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M11 5h10"/><path d="M11 9h7"/><path d="M11 13h4"/><path d="M3 17l3 3 3-3"/><path d="M6 18V4"/></svg>',_t='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>',zs='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="9 18 15 12 9 6"/></svg>',Ks={"sort.newest":"Newest first","sort.oldest":"Oldest first","sort.byType":"By type","sort.openFirst":"Open first","sort.label":"Sort","group.byPage":"By page","group.feedbacks":"{count} feedbacks"},Ys={"sort.newest":"Plus r\xE9cents","sort.oldest":"Plus anciens","sort.byType":"Par type","sort.openFirst":"Ouverts d'abord","sort.label":"Trier","group.byPage":"Par page","group.feedbacks":"{count} feedbacks"},$t={question:0,change:1,bug:2,other:3};function jt(s,e){let t=[...s];switch(e){case"newest":t.sort((n,i)=>new Date(i.createdAt).getTime()-new Date(n.createdAt).getTime());break;case"oldest":t.sort((n,i)=>new Date(n.createdAt).getTime()-new Date(i.createdAt).getTime());break;case"by-type":t.sort((n,i)=>{let o=$t[n.type]??99,r=$t[i.type]??99;return o!==r?o-r:new Date(i.createdAt).getTime()-new Date(n.createdAt).getTime()});break;case"open-first":t.sort((n,i)=>{let o=n.status==="open"?0:1,r=i.status==="open"?0:1;return o!==r?o-r:new Date(i.createdAt).getTime()-new Date(n.createdAt).getTime()});break}return t}function qs(s){try{return new URL(s).pathname}catch{return s}}function Us(s,e){if(s.length<=e)return s;let t="\u2026",n=Math.floor((e-1)/2);return s.slice(0,n)+t+s.slice(-n)}function zt(s){let e=new Map;for(let n of s){let i=qs(n.url),o=e.get(i);o?o.push(n):e.set(i,[n])}return new Map([...e.entries()].sort((n,i)=>i[1].length-n[1].length))}function Kt(s,e,t){let n=l("div",{class:"sp-group-header"});n.setAttribute("role","button"),n.setAttribute("tabindex","0"),n.setAttribute("aria-expanded","true"),n.style.borderBottomColor=t.border;let i=l("span",{class:"sp-group-header-chevron"});i.appendChild(v(zs)),n.appendChild(i);let o=l("span",{class:"sp-group-header-icon"});o.appendChild(v(_t)),n.appendChild(o);let r=l("span",{class:"sp-group-header-path"}),a=Us(s,40);h(r,a),s.length>40&&(r.title=s),n.appendChild(r);let p=l("span",{class:"sp-group-header-count"});p.style.background=t.accentLight,p.style.color=t.accent,h(p,String(e)),n.appendChild(p);let d=()=>{let c=n.getAttribute("aria-expanded")==="true";n.setAttribute("aria-expanded",String(!c)),n.classList.toggle("sp-group-header--collapsed",c);let b=n.nextElementSibling;b?.classList.contains("sp-group-content")&&b.classList.toggle("sp-group-content--collapsed",c)};return n.addEventListener("click",d),n.addEventListener("keydown",c=>{(c.key==="Enter"||c.key===" ")&&(c.preventDefault(),d())}),n}var ce=class{element;_sortMode="newest";_groupByPage=!1;menuEl=null;sortBtn;groupToggle;i18n;colors;onChange;outsideClickHandler=null;constructor(e,t,n){this.colors=e,this.onChange=t,this.i18n=n==="fr"?Ys:Ks,this.element=l("div",{class:"sp-sort-controls"}),this.sortBtn=document.createElement("button"),this.sortBtn.className="sp-sort-btn",this.sortBtn.setAttribute("aria-haspopup","listbox"),this.sortBtn.setAttribute("aria-expanded","false"),this.sortBtn.setAttribute("aria-label",this.i18n["sort.label"]);let i=v(js);this.sortBtn.appendChild(i);let o=l("span",{class:"sp-sort-btn-label"});h(o,this.i18n["sort.newest"]),this.sortBtn.appendChild(o),this.sortBtn.addEventListener("click",p=>{p.stopPropagation(),this.toggleMenu()}),this.groupToggle=document.createElement("button"),this.groupToggle.className="sp-group-toggle",this.groupToggle.setAttribute("aria-pressed","false");let r=v(_t);this.groupToggle.appendChild(r);let a=l("span",{class:"sp-group-toggle-label"});h(a,this.i18n["group.byPage"]),this.groupToggle.appendChild(a),this.groupToggle.addEventListener("click",()=>{this._groupByPage=!this._groupByPage,this.groupToggle.classList.toggle("sp-group-toggle--active",this._groupByPage),this.groupToggle.setAttribute("aria-pressed",String(this._groupByPage)),this.onChange()}),this.element.appendChild(this.sortBtn),this.element.appendChild(this.groupToggle)}get sortMode(){return this._sortMode}get groupByPage(){return this._groupByPage}toggleMenu(){if(this.menuEl){this.closeMenu();return}this.openMenu()}openMenu(){this.menuEl=l("div",{class:"sp-sort-menu"}),this.menuEl.setAttribute("role","listbox"),this.menuEl.setAttribute("aria-label",this.i18n["sort.label"]),this.sortBtn.setAttribute("aria-expanded","true");let e=[{mode:"newest",label:this.i18n["sort.newest"]},{mode:"oldest",label:this.i18n["sort.oldest"]},{mode:"by-type",label:this.i18n["sort.byType"]},{mode:"open-first",label:this.i18n["sort.openFirst"]}];for(let t of e){let n=document.createElement("button");n.className=`sp-sort-option${t.mode===this._sortMode?" sp-sort-option--active":""}`,n.setAttribute("role","option"),n.setAttribute("aria-selected",String(t.mode===this._sortMode)),t.mode===this._sortMode&&(n.style.background=this.colors.accentLight,n.style.color=this.colors.accent),h(n,t.label),n.addEventListener("click",i=>{i.stopPropagation(),this._sortMode=t.mode,this.updateSortLabel(),this.closeMenu(),this.onChange()}),this.menuEl.appendChild(n)}this.element.appendChild(this.menuEl),requestAnimationFrame(()=>{this.outsideClickHandler=t=>{this.menuEl&&!this.element.contains(t.target)&&this.closeMenu()},document.addEventListener("click",this.outsideClickHandler,!0)}),this.menuEl.addEventListener("keydown",t=>{t.key==="Escape"&&(this.closeMenu(),this.sortBtn.focus())})}closeMenu(){this.menuEl&&(this.menuEl.remove(),this.menuEl=null),this.sortBtn.setAttribute("aria-expanded","false"),this.outsideClickHandler&&(document.removeEventListener("click",this.outsideClickHandler,!0),this.outsideClickHandler=null)}updateSortLabel(){let e={newest:this.i18n["sort.newest"],oldest:this.i18n["sort.oldest"],"by-type":this.i18n["sort.byType"],"open-first":this.i18n["sort.openFirst"]},t=this.sortBtn.querySelector(".sp-sort-btn-label");t&&h(t,e[this._sortMode])}destroy(){this.closeMenu()}},Yt=`
  /* ============================
...
`;function ze(s){return`
    ...
    *, *::before, *::after {
    ...
    ${Wt}
    ${Dt}
  `}var tn=120,sn=80,me=class{constructor(e,t="en"){this.colors=e;this.locale=t;this.root=l("div",{style:`
        position: fixed;
        z-index: ${2147483647};
        max-width: 280px;
        padding: 12px 14px;
